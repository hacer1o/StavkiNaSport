...
void debug_file (int debug_code, int debug_status) {
	...
	if (debug_code == 1) {
		fout << "Вибрані команди" << debug_status << endl;
	}
	else if (debug_code == 2) {
		fout << "2 слой" << debug_status << endl;
	}
	else if (debug_code == 3) {
		fout << "3 слой" << debug_status << endl;
	}
	else if (debug_code == 4) {
		fout << "4 слой" << debug_status << endl;
	}
	else if (debug_code == 5) {
		fout << "Вивід" << debug_status << endl;
	}
	fout.close();
}
#ednif